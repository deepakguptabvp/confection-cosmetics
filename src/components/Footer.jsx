...
const Footer = () => {
  return (
    <div>
      <footer className="bg-white  dark:bg-stone-700 shadow-md">
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              ...
              <p className="text-sm m-1 text-gray-500 dark:text-gray-400 font-medium">
                Sweeten your beauty | Where confection meets cosmetics.
              </p>
              <p className=" mt-5 ml-1 dark:text-white font-medium">
                Payment
              </p>
              <button
                type="button"
          ...
          {/* <div className="max-w-screen-2xl bg-slate-400"> */}
          <hr className="my-6 max-w-screen-xl border-gray-200 sm:mx-auto lg:my-4" />

          {/* bottom footer icon's and right's reserved... */}
